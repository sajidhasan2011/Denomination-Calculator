...
def topwin():
    ...
    label = Label(top,text="Enter Total amount",bg='blue')
    entry = Entry(top)
    lbl = Label(top,text="Here are number of notes for each Denomination",bg='blue')
    
    l1 = Label(top, text="1000",bg='blue')
    l2 = Label(top, text="500",bg='blue')
    l3 = Label(top, text="100",bg='blue')
